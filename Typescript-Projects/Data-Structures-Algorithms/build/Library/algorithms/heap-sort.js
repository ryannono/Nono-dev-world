 ...
 */
function getMaxChildIndex(array, itemIndex, comparator) {
 ...
 */
function siftUp(array, startIndex, comparator) {
 ...
 */
function siftDown(array, startIndex, partitionLength, comparator) {
    let currIndex = startIndex;
    let maxChildIndex;
    while ((maxChildIndex = getMaxChildIndex(array, currIndex, comparator)) !== null &&
 ...
 * @param comparator - A function that compares two elements and returns a number.
 */
function moveMax(array, partitionLength, comparator) {
...
function heapSort(array, comparator = comparator_1.defaultComparator) {
    ...
    while (length)
        moveMax(array, length--, comparator);
    return array;
}
